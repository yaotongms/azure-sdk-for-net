...
namespace Azure.ResourceManager.HybridCompute
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="HybridComputePrivateEndpointConnectionResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="HybridComputePrivateLinkScopeResource"/> using the GetHybridComputePrivateEndpointConnections method.
    /// </summary>
    public partial class HybridComputePrivateEndpointConnectionResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of HybridComputePrivateEndpointConnectionResource for mocking. </summary>
        protected HybridComputePrivateEndpointConnectionResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="HybridComputePrivateEndpointConnectionResource"/> class. </summary>
        ...
        {
            TryGetApiVersion(ResourceType, out string hybridComputePrivateEndpointConnectionApiVersion);
            _privateEndpointConnectionsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.HybridCompute", ResourceType.Namespace, Diagnostics);
            _privateEndpointConnectionsRestClient = new PrivateEndpointConnections(_privateEndpointConnectionsClientDiagnostics, Pipeline, Endpoint, hybridComputePrivateEndpointConnectionApiVersion ?? "2026-06-16-preview");
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridCompute/privateLinkScopes/{scopeName}/privateEndpointConnections/{privateEndpointConnectionName}";
        ...
        {
            using DiagnosticScope scope = _privateEndpointConnectionsClientDiagnostics.CreateScope("HybridComputePrivateEndpointConnectionResource.Get");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = _privateEndpointConnectionsClientDiagnostics.CreateScope("HybridComputePrivateEndpointConnectionResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HybridComputeArmOperation operation = new HybridComputeArmOperation(_privateEndpointConnectionsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        /// <summary>
        /// Update a HybridComputePrivateEndpointConnection.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridCompute/privateLinkScopes/{scopeName}/privateEndpointConnections/{privateEndpointConnectionName}. </description>
        ...
        public virtual async Task<ArmOperation<HybridComputePrivateEndpointConnectionResource>> UpdateAsync(WaitUntil waitUntil, HybridComputePrivateEndpointConnectionData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _privateEndpointConnectionsClientDiagnostics.CreateScope("HybridComputePrivateEndpointConnectionResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _privateEndpointConnectionsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, HybridComputePrivateEndpointConnectionData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
