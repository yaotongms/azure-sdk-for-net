...
namespace Azure.ResourceManager.HybridCompute
{
    ...
    public partial class HybridComputeMachineResource : ArmResource
    {
        ...
        internal HybridComputeMachineResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _machinesRestClient = new Machines(_machinesClientDiagnostics, Pipeline, Endpoint, hybridComputeMachineApiVersion ?? "2026-06-16-preview");
            ...
            _privateLinkScopesRestClient = new PrivateLinkScopes(_privateLinkScopesClientDiagnostics, Pipeline, Endpoint, hybridComputeMachineApiVersion ?? "2026-06-16-preview");
            ...
            _networkProfileRestClient = new NetworkProfile(_networkProfileClientDiagnostics, Pipeline, Endpoint, hybridComputeMachineApiVersion ?? "2026-06-16-preview");
            ...
            _hybridComputeClientRestClient = new HybridComputeClient(_hybridComputeClientClientDiagnostics, Pipeline, Endpoint, hybridComputeMachineApiVersion ?? "2026-06-16-preview");
        ...
        public virtual async Task<Response<HybridComputeMachineResource>> GetAsync(string expand = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _machinesRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, expand, context);
        ...
        public virtual async Task<Response<HybridComputeMachineResource>> UpdateAsync(HybridComputeMachinePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _machinesRestClient.CreateUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, HybridComputeMachinePatch.ToRequestContent(patch), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<HybridComputeMachineData> response = Response.FromValue(HybridComputeMachineData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _machinesRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
        ...
        public virtual async Task<ArmOperation<MachineAssessPatchesResult>> AssessPatchesAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _machinesRestClient.CreateAssessPatchesRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        public virtual async Task<Response<PrivateLinkScopeValidationDetails>> GetValidationDetailsForMachinePrivateLinkScopeAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _privateLinkScopesRestClient.CreateGetValidationDetailsForMachinePrivateLinkScopeRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        public virtual async Task<ArmOperation<MachineInstallPatchesResult>> InstallPatchesAsync(WaitUntil waitUntil, MachineInstallPatchesContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _machinesRestClient.CreateInstallPatchesRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, MachineInstallPatchesContent.ToRequestContent(content), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        public virtual async Task<Response<HybridComputeNetworkProfile>> GetNetworkProfileAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _networkProfileRestClient.CreateGetNetworkProfileRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        public virtual async Task<ArmOperation<SetupExtensionContent>> SetupExtensionsAsync(WaitUntil waitUntil, SetupExtensionContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _hybridComputeClientRestClient.CreateSetupExtensionsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, SetupExtensionContent.ToRequestContent(content), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        public virtual async Task<ArmOperation> UpgradeExtensionsAsync(WaitUntil waitUntil, MachineExtensionUpgrade extensionUpgradeParameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _hybridComputeClientRestClient.CreateUpgradeExtensionsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, MachineExtensionUpgrade.ToRequestContent(extensionUpgradeParameters), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        public virtual async Task<Response<HybridComputeMachineResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
                {
                    ...
                    HttpMessage message = _machinesRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, default, context);
                    Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                    Response<HybridComputeMachineData> response = Response.FromValue(HybridComputeMachineData.FromResponse(result), result);
                    return Response.FromValue(new HybridComputeMachineResource(Client, response.Value), response.GetRawResponse());
                }
