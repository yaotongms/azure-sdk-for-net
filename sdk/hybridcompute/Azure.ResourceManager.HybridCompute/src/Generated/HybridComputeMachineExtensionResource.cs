...
namespace Azure.ResourceManager.HybridCompute
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="HybridComputeMachineExtensionResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="HybridComputeMachineResource"/> using the GetHybridComputeMachineExtensions method.
    /// </summary>
    public partial class HybridComputeMachineExtensionResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of HybridComputeMachineExtensionResource for mocking. </summary>
        protected HybridComputeMachineExtensionResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="HybridComputeMachineExtensionResource"/> class. </summary>
        ...
        {
            TryGetApiVersion(ResourceType, out string hybridComputeMachineExtensionApiVersion);
            _machineExtensionsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.HybridCompute", ResourceType.Namespace, Diagnostics);
            _machineExtensionsRestClient = new MachineExtensions(_machineExtensionsClientDiagnostics, Pipeline, Endpoint, hybridComputeMachineExtensionApiVersion ?? "2026-06-16-preview");
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridCompute/machines/{machineName}/extensions/{extensionName}";
        ...
        {
            using DiagnosticScope scope = _machineExtensionsClientDiagnostics.CreateScope("HybridComputeMachineExtensionResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _machineExtensionsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
        ...
        public virtual async Task<ArmOperation<HybridComputeMachineExtensionResource>> UpdateAsync(WaitUntil waitUntil, HybridComputeMachineExtensionPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _machineExtensionsClientDiagnostics.CreateScope("HybridComputeMachineExtensionResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _machineExtensionsRestClient.CreateUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, HybridComputeMachineExtensionPatch.ToRequestContent(patch), context);
        ...
        {
            using DiagnosticScope scope = _machineExtensionsClientDiagnostics.CreateScope("HybridComputeMachineExtensionResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _machineExtensionsRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                HybridComputeArmOperation operation = new HybridComputeArmOperation(_machineExtensionsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                {
        ...
        public virtual async Task<Response<HybridComputeMachineExtensionResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _machineExtensionsClientDiagnostics.CreateScope("HybridComputeMachineExtensionResource.AddTag");
            scope.Start();
            try
            {
                ...
                {
                    HybridComputeMachineExtensionData current = (await GetAsync(cancellationToken: cancellationToken).ConfigureAwait(false)).Value.Data;
                    ...
                    ArmOperation<HybridComputeMachineExtensionResource> result = await UpdateAsync(WaitUntil.Completed, patch, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<HybridComputeMachineExtensionResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                {
                    HybridComputeMachineExtensionData current = Get(cancellationToken: cancellationToken).Value.Data;
                    HybridComputeMachineExtensionPatch patch = new HybridComputeMachineExtensionPatch();
                    foreach (KeyValuePair<string, string> tag in current.Tags)
                    {
                        patch.Tags.Add(tag);
                    ...
                    patch.Tags[key] = value;
                    ArmOperation<HybridComputeMachineExtensionResource> result = Update(WaitUntil.Completed, patch, cancellationToken: cancellationToken);
                    return Response.FromValue(result.Value, result.GetRawResponse());
                }
            }
            catch (Exception e)
        ...
        public virtual async Task<Response<HybridComputeMachineExtensionResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _machineExtensionsClientDiagnostics.CreateScope("HybridComputeMachineExtensionResource.SetTags");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
        ...
        public virtual async Task<Response<HybridComputeMachineExtensionResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _machineExtensionsClientDiagnostics.CreateScope("HybridComputeMachineExtensionResource.RemoveTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
