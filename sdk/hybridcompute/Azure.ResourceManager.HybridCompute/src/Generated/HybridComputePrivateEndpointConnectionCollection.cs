...
namespace Azure.ResourceManager.HybridCompute
{
    ...
    public partial class HybridComputePrivateEndpointConnectionCollection : ArmCollection, IEnumerable<HybridComputePrivateEndpointConnectionResource>, IAsyncEnumerable<HybridComputePrivateEndpointConnectionResource>
    {
        ...
        /// <summary> Initializes a new instance of HybridComputePrivateEndpointConnectionCollection for mocking. </summary>
        protected HybridComputePrivateEndpointConnectionCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="HybridComputePrivateEndpointConnectionCollection"/> class. </summary>
        ...
        public virtual async Task<ArmOperation<HybridComputePrivateEndpointConnectionResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string privateEndpointConnectionName, HybridComputePrivateEndpointConnectionData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _privateEndpointConnectionsClientDiagnostics.CreateScope("HybridComputePrivateEndpointConnectionCollection.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<HybridComputePrivateEndpointConnectionResource>> GetAsync(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _privateEndpointConnectionsClientDiagnostics.CreateScope("HybridComputePrivateEndpointConnectionCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual AsyncPageable<HybridComputePrivateEndpointConnectionResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<HybridComputePrivateEndpointConnectionData, HybridComputePrivateEndpointConnectionResource>(new PrivateEndpointConnectionsGetByPrivateLinkScopeAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "HybridComputePrivateEndpointConnectionCollection.GetAll"), data => new HybridComputePrivateEndpointConnectionResource(Client, data));
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _privateEndpointConnectionsClientDiagnostics.CreateScope("HybridComputePrivateEndpointConnectionCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                {
                    case 200:
                        response = Response.FromValue(HybridComputePrivateEndpointConnectionData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((HybridComputePrivateEndpointConnectionData)null, result);
                        break;
                    default:
        ...
        public virtual async Task<NullableResponse<HybridComputePrivateEndpointConnectionResource>> GetIfExistsAsync(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _privateEndpointConnectionsClientDiagnostics.CreateScope("HybridComputePrivateEndpointConnectionCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
