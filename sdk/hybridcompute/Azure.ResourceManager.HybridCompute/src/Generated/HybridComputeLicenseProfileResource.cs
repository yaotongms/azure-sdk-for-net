...
namespace Azure.ResourceManager.HybridCompute
{
    ...
    public partial class HybridComputeLicenseProfileResource : ArmResource
    {
        ...
        internal HybridComputeLicenseProfileResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _licenseProfilesRestClient = new LicenseProfiles(_licenseProfilesClientDiagnostics, Pipeline, Endpoint, hybridComputeLicenseProfileApiVersion ?? "2026-06-16-preview");
        ...
        public virtual async Task<Response<HybridComputeLicenseProfileResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _licenseProfilesRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, context);
        ...
        public virtual async Task<ArmOperation<HybridComputeLicenseProfileResource>> UpdateAsync(WaitUntil waitUntil, HybridComputeLicenseProfilePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _licenseProfilesRestClient.CreateUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, HybridComputeLicenseProfilePatch.ToRequestContent(patch), context);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _licenseProfilesRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
